"""Regression checks for the parity-algo-geometry-stack casebook."""
...
from casebook.harness import assert_expected, parity_algo_geometry_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(parity_algo_geometry_stack_summary(), assert_expected())
